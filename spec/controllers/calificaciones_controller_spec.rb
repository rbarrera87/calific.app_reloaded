...
describe CalificacionesController do
  ...
  let(:valid_attributes) { { "valor" => "" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # CalificacionesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved calificacion as @calificacion" do
        ...
        post :create, {:calificacion => { "valor" => "invalid value" }}, valid_session
        assigns(:calificacion).should be_a_new(Calificacion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested calificacion" do
        ...
        Calificacion.any_instance.should_receive(:update).with({ "valor" => "" })
        put :update, {:id => calificacion.to_param, :calificacion => { "valor" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the calificacion as @calificacion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Calificacion.any_instance.stub(:save).and_return(false)
        put :update, {:id => calificacion.to_param, :calificacion => { "valor" => "invalid value" }}, valid_session
        assigns(:calificacion).should eq(calificacion)
      end
