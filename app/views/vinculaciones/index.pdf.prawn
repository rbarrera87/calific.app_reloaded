	...
	move_down 20
	text "<#{n1}>MIA #{a.nombre_director} </#{n1}>", :inline_format => true
	text "<#{n1}>DIRECTORA DEL PROGRAMA EDUCATIVO DE #{a.carrera.nombre}</#{n1}>", :inline_format => true
